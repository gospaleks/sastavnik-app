...
export const metadata: Metadata = {
  title: {
    template: '%s | Sastavnik - Kreiraj. Uči. Inspiriši.',
    default: 'Sastavnik - Kreiraj. Uči. Inspiriši.',
  },
  description:
    'Sastavnik je web platforma za pregled, kreiranje i deljenje školskih sastava za sve razrede. Otkrij inspiraciju, postavi svoje radove i oceni tuđe sastave.',
};
